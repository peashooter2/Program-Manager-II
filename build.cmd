...
if "%1" == "debug" (
    set CL=/MTd /Od /ZI /JMC /RTC1 /Fdprogmgr.pdb /fsanitize=address /DUNICODE /D_DEBUG /DPROGMGR_DEBUG /DPROGMGR_GIT_HASH="%GIT_HASH%"
    set LINK=/DEBUG
) else (
    set CL=/O2 /Ob3 /GS- /DUNICODE /DNDEBUG /DPROGMGR_RELEASE /DPROGMGR_GIT_HASH="%GIT_HASH%"
